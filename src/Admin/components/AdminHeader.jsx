        ...
        <div className='bg-linear-to-r from-[#334ed6] to-[#1E1E2F]'>
            <div className=' py-2 px-2 md:px-5 w-full grid grid-cols-2 items-center '>
                ...
                <div className=' flex gap-2 items-center justify-end'>
                    <img style={{ height: "60px", width: "60px", borderRadius: "30px" }} src="https://media.istockphoto.com/id/522855255/vector/male-profile-flat-blue-simple-icon-with-long-shadow.jpg?s=612x612&w=0&k=20&c=EQa9pV1fZEGfGCW_aEK5X_Gyob8YuRcOYCYZeuBzztM=" alt="" />
