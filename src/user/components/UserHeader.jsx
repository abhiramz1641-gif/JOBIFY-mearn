        ...
        <div>
            <div className=' py-2 px-2 md:px-5 w-full grid grid-cols-2 items-center '>
                ...
                <div className=' flex gap-2 items-center justify-end'>
                    ...
                    <Link to={'/login'}><button className=' hover:scale-103 p-1 sm:p-2 sm:px-2 md:px-4 rounded bg-white border border-gray-600 text-gray-600 font-semibold shadow-2xl shadow-black'>Log Out</button></Link>
                </div>
            </div >
        </div>
    )
