                        ...
                        <div className=' grid lg:grid-cols-2 px-5 gap-5'>
                            ...
                            <div className='border border-blue-400 rounded-xl h-full p-5'>
                                <div className=' flex justify-between items-center'>
                                    ...
                                    <div>
                                        <Link to={'/JobEdit'}><button className=' hover:scale-101 hover:shadow-2xl hover:shadow-gray-500 p-2 px-4 bg-blue-900 text-white rounded'>Edit <FontAwesomeIcon icon={faPenToSquare} /></button></Link>
                                    </div>
                                </div>
